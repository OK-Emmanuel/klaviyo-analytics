...
# def simulate_orders():
#     """Simulate Placed Order events for testing"""
#     orders = [
#         {"customer": "new1@example.com", "value": 50, "campaign": "01JMFA87KG9GMCSA6Z9XT8JC9M", "time": "2025-02-20T12:00:00Z"},
#         {"customer": "new2@example.com", "value": 75, "flow": "SCJATy", "time": "2024-11-01T10:00:00Z"},
#         {"customer": "rec1@example.com", "value": 100, "campaign": "01JAJR8CJZ93V5EQXRAQXHRBYQ", "time": "2024-10-20T15:00:00Z"},
#         {"customer": "rec1@example.com", "value": 150, "flow": "UkzQ6P", "time": "2024-12-01T14:00:00Z"},
#         {"customer": "rec2@example.com", "value": 80, "campaign": "01J95DW44SMV79SY40QE24C5QW", "time": "2024-10-03T09:00:00Z"},
#         {"customer": "rec2@example.com", "value": 120, "flow": "SCJATy", "time": "2024-11-15T11:00:00Z"},
#         {"customer": "mix1@example.com", "value": 90, "campaign": "01JMFA87KG9GMCSA6Z9XT8JC9M", "time": "2025-01-15T13:00:00Z"},
#         {"customer": "mix1@example.com", "value": 200, "flow": "VpJSR4", "time": "2025-02-01T16:00:00Z"}
#     ]
...
#             "event": "Placed Order",
#             "customer_properties": {"$email": order["customer"]},
#             "properties": {
#                 "$value": order["value"],
#                 "$attributed_message" if "campaign" in order else "$attributed_flow": order.get("campaign", order.get("flow"))
#             },
#             "time": int(datetime.fromisoformat(order["time"].replace("Z", "+00:00")).timestamp())
#         }
#         response = make_klaviyo_request("track", method="POST", json_body=payload, use_track=True)
#         print(f"Simulated order for {order['customer']} - Response: {response}")
...
#         # Simulate orders
#         print("Simulating mock orders...")
#         simulate_orders()
#         print("Waiting 120 seconds for events to process...")
#         time.sleep(120)  # Increased delay
